...
then:                                             ; preds = %entry
  ...
  %">5" = icmp sgt i32 75, %test4
  br i1 %">5", label %then7, label %else11
...
else11:                                           ; preds = %else
  ...
  %">14" = icmp sgt i32 65, %test13
  br i1 %">14", label %then16, label %else20
