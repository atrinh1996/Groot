...
%_anon11_struct = type { i1 (i1)* }
%_anon0_struct = type { i32 (i32)* }
%_anon1_struct = type { i32 (i32)* }
%_anon7_struct = type { i8* (i8*)* }
%_anon9_struct = type { i32 (i32)* }
%_anon10_struct = type { i1 (%_anon11_struct*, i1)* }
%_anon8_struct = type { i32 (%_anon9_struct*, i32)* }
%_anon6_struct = type { i8* (%_anon7_struct*, i8*)* }
%_anon5_struct = type { i32 (%_anon1_struct*, i32)* }
%_anon4_struct = type { i32 (%_anon0_struct*, i32)* }
...
@__anon10_1 = global i1 (%_anon11_struct*, i1)* null
@__anon11_1 = global i1 (i1)* null
@__anon2_1 = global i32 (i32)* null
@__anon4_1 = global i32 (%_anon0_struct*, i32)* null
@__anon5_1 = global i32 (%_anon1_struct*, i32)* null
@__anon6_1 = global i8* (%_anon7_struct*, i8*)* null
@__anon7_1 = global i8* (i8*)* null
@__anon8_1 = global i32 (%_anon9_struct*, i32)* null
...
@_callFunc_3 = global %_anon6_struct* null
@_callFunc_2 = global %_anon5_struct* null
@_callFunc_1 = global %_anon4_struct* null
@_retx_4 = global %_anon11_struct* null
@_retx_3 = global %_anon9_struct* null
@_retx_2 = global %_anon7_struct* null
...
entry:
  ...
  store i32 (%_anon0_struct*, i32)* @_anon4, i32 (%_anon0_struct*, i32)** %funcField6, align 8
  ...
  store i32 (%_anon1_struct*, i32)* @_anon5, i32 (%_anon1_struct*, i32)** %funcField8, align 8
  store %_anon5_struct* %gstruct7, %_anon5_struct** @_callFunc_2, align 8
  %_callFunc_2 = load %_anon5_struct*, %_anon5_struct** @_callFunc_2, align 8
  %_sub1_1 = load %_anon1_struct*, %_anon1_struct** @_sub1_1, align 8
  %function_access9 = getelementptr inbounds %_anon5_struct, %_anon5_struct* %_callFunc_2, i32 0, i32 0
  %function_call10 = load i32 (%_anon1_struct*, i32)*, i32 (%_anon1_struct*, i32)** %function_access9, align 8
  %function_result11 = call i32 %function_call10(%_anon1_struct* %_sub1_1, i32 43)
  %printi12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i32 %function_result11)
  ...
  store i8* (i8*)* @_anon7, i8* (i8*)** %funcField14, align 8
  store %_anon7_struct* %gstruct13, %_anon7_struct** @_retx_2, align 8
  %gstruct15 = alloca %_anon6_struct, align 8
  %funcField16 = getelementptr inbounds %_anon6_struct, %_anon6_struct* %gstruct15, i32 0, i32 0
  store i8* (%_anon7_struct*, i8*)* @_anon6, i8* (%_anon7_struct*, i8*)** %funcField16, align 8
  store %_anon6_struct* %gstruct15, %_anon6_struct** @_callFunc_3, align 8
  %_callFunc_3 = load %_anon6_struct*, %_anon6_struct** @_callFunc_3, align 8
  %_retx_2 = load %_anon7_struct*, %_anon7_struct** @_retx_2, align 8
  ...
  %function_access17 = getelementptr inbounds %_anon6_struct, %_anon6_struct* %_callFunc_3, i32 0, i32 0
  %function_call18 = load i8* (%_anon7_struct*, i8*)*, i8* (%_anon7_struct*, i8*)** %function_access17, align 8
  %function_result19 = call i8* %function_call18(%_anon7_struct* %_retx_2, i8* %character_ptr)
  %printc = call i32 @puts(i8* %function_result19)
  %gstruct20 = alloca %_anon9_struct, align 8
  %funcField21 = getelementptr inbounds %_anon9_struct, %_anon9_struct* %gstruct20, i32 0, i32 0
  store i32 (i32)* @_anon9, i32 (i32)** %funcField21, align 8
  store %_anon9_struct* %gstruct20, %_anon9_struct** @_retx_3, align 8
  %gstruct22 = alloca %_anon8_struct, align 8
  %funcField23 = getelementptr inbounds %_anon8_struct, %_anon8_struct* %gstruct22, i32 0, i32 0
  store i32 (%_anon9_struct*, i32)* @_anon8, i32 (%_anon9_struct*, i32)** %funcField23, align 8
  store %_anon8_struct* %gstruct22, %_anon8_struct** @_callFunc_4, align 8
  %_callFunc_4 = load %_anon8_struct*, %_anon8_struct** @_callFunc_4, align 8
  %_retx_3 = load %_anon9_struct*, %_anon9_struct** @_retx_3, align 8
  %function_access24 = getelementptr inbounds %_anon8_struct, %_anon8_struct* %_callFunc_4, i32 0, i32 0
  %function_call25 = load i32 (%_anon9_struct*, i32)*, i32 (%_anon9_struct*, i32)** %function_access24, align 8
  %function_result26 = call i32 %function_call25(%_anon9_struct* %_retx_3, i32 42)
  ...
  store i1 (i1)* @_anon11, i1 (i1)** %funcField29, align 8
  store %_anon11_struct* %gstruct28, %_anon11_struct** @_retx_4, align 8
  ...
  store i1 (%_anon11_struct*, i1)* @_anon10, i1 (%_anon11_struct*, i1)** %funcField31, align 8
  ...
  %_retx_4 = load %_anon11_struct*, %_anon11_struct** @_retx_4, align 8
  %function_access32 = getelementptr inbounds %_anon10_struct, %_anon10_struct* %_callFunc_5, i32 0, i32 0
  %function_call33 = load i1 (%_anon11_struct*, i1)*, i1 (%_anon11_struct*, i1)** %function_access32, align 8
  %function_result34 = call i1 %function_call33(%_anon11_struct* %_retx_4, i1 true)
  %printb = call i32 @puts(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @boolF, i32 0, i32 0))
  ret i32 0
}

define i1 @_anon10(%_anon11_struct* %func, i1 %arg) {
entry:
...
define i32 @_anon8(%_anon9_struct* %func, i32 %arg) {
entry:
...
define i8* @_anon6(%_anon7_struct* %func, i8* %arg) {
entry:
  %func1 = alloca %_anon7_struct*, align 8
  store %_anon7_struct* %func, %_anon7_struct** %func1, align 8
  %arg2 = alloca i8*, align 8
  store i8* %arg, i8** %arg2, align 8
  %func3 = load %_anon7_struct*, %_anon7_struct** %func1, align 8
  %arg4 = load i8*, i8** %arg2, align 8
  %function_access = getelementptr inbounds %_anon7_struct, %_anon7_struct* %func3, i32 0, i32 0
...
define i32 @_anon5(%_anon1_struct* %func, i32 %arg) {
entry:
...
define i32 @_anon4(%_anon0_struct* %func, i32 %arg) {
entry:
