...
%_anon0_struct = type { i32 (i1, i1, i32)* }
...
@__anon0_1 = global i32 (i1, i1, i32)* null
...
entry:
  ...
  store i32 (i1, i1, i32)* @_anon0, i32 (i1, i1, i32)** %funcField, align 8
...
define i32 @_anon0(i1 %x, i1 %y, i32 %z) {
entry:
...
then:                                             ; preds = %entry
  %x6 = load i1, i1* %x1, align 1
  %y7 = load i1, i1* %y2, align 1
  %"||" = or i1 %x6, %y7
  store i1 %"||", i32* %if-res-ptr, align 1
  br label %merge

else:                                             ; preds = %entry
  %x8 = load i1, i1* %x1, align 1
  %y9 = load i1, i1* %y2, align 1
  %"&&" = and i1 %x8, %y9
  store i1 %"&&", i32* %if-res-ptr, align 1
  br label %merge
}
