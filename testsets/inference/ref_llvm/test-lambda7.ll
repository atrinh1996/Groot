...
%_anon0_struct = type { i1 (i1, i1)* }

@fmt = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@boolT = private unnamed_addr constant [3 x i8] c"#t\00", align 1
@boolF = private unnamed_addr constant [3 x i8] c"#f\00", align 1
@__anon0_1 = global i1 (i1, i1)* null
...
entry:
  ...
  store i1 (i1, i1)* @_anon0, i1 (i1, i1)** %funcField, align 8
  ret i32 0
}

define i1 @_anon0(i1 %x, i1 %y) {
entry:
  ...
  %y3 = load i1, i1* %y2, align 1
  br i1 %y3, label %then, label %else
...
then:                                             ; preds = %entry
  ...
  store i1 %y5, i1* %if-res-ptr, align 1
  br label %merge
}
