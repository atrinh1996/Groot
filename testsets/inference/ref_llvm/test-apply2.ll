...
entry:
  ...
  %_test_1 = load %_anon1_struct*, %_anon1_struct** @_test_1, align 8
  %freePtr = getelementptr inbounds %_anon1_struct, %_anon1_struct* %_test_1, i32 0, i32 1
  %freeVal = load %_anon0_struct*, %_anon0_struct** %freePtr, align 8
  %function_access = getelementptr inbounds %_anon1_struct, %_anon1_struct* %_test_1, i32 0, i32 0
