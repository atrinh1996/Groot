...
entry:
  ...
  %function_result = call i32 %function_call(i32 3)
  %addition = add i32 %function_result, 2
  %printi = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i32 %addition)
  ret i32 0
}
