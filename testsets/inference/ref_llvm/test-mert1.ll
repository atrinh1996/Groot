...
%anon0_struct = type { i32 (i1)* }

@fmt = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1
@boolT = private unnamed_addr constant [3 x i8] c"#t\00", align 1
@boolF = private unnamed_addr constant [3 x i8] c"#f\00", align 1
@_anon0_1 = global i32 (i1)* null
@_x_1 = global %anon0_struct* null
@_y_1 = global i32 0
...
entry:
  ...
  store i32 (i1)* @anon0, i32 (i1)** %funcField, align 8
  store %anon0_struct* %gstruct, %anon0_struct** @_x_1, align 8
  %_x_1 = load %anon0_struct*, %anon0_struct** @_x_1, align 8
  %function_access = getelementptr inbounds %anon0_struct, %anon0_struct* %_x_1, i32 0, i32 0
