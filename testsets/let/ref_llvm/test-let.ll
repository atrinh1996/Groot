...
entry:
  ...
  %y9 = load i32, i32* %y7, align 4
  %z10 = load i32, i32* %z, align 4
  %multiply = mul i32 %y9, %z10
  %multiply11 = mul i32 %x8, %multiply
  %printi12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i32 %multiply11)
  ret i32 0
}
